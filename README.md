...
Prepare Data: Ensure your results are calculated using the TMMLU+ methodology and formatted to match results/benchmark.csv.

Submit an Issue: Click the "Submit Your Model Results" button on the live leaderboard website to fill out a pre-formatted request.

Pull Request: Alternatively, fork this repo, add your model's column to the CSV, and submit a PR.
